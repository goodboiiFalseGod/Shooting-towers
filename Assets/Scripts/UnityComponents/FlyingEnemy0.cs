...
public class FlyingEnemy0 : EnemyBase
{
    ...
    protected override void CreateEntity()
    {
        ...
        ref EnemyBaseRef EnemyBaseRefComponent = ref flyingEnemyEntity.Get<EnemyBaseRef>();
        ref Reward rewardComponent = ref flyingEnemyEntity.Get<Reward>();
